...
export default function SonsOfTheForestPage() {
  const downloadLink = "#"; // Remplace par ton lien réel
        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <Link href="/">
            <div className="group flex items-center gap-1 cursor-pointer">
              ...
              <span className="text-2xl font-black italic tracking-tighter text-orange-600 drop-shadow-[0_0_10px_rgba(234,88,12,0.5)]">GAMES</span>
            </div>
          </Link>
      ...
      <main className="pt-32 pb-20 max-w-7xl mx-auto px-6">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-3 gap-12 mb-20">
          ...
          >
            <div className="sticky top-40">
              <div className="relative rounded-[2rem] overflow-hidden border border-white/10 shadow-2xl shadow-orange-900/20">
                <img 
                  src="https://ankergames.net/uploads/poster/10-2024/gtCM3aiaZc.webp" 
                  alt="Sons Of The Forest Poster" 
              ...
              <a href={downloadLink} target="_blank" rel="noopener noreferrer" className="block w-full">
                <button className="w-full mt-6 bg-orange-700 hover:bg-orange-600 text-white font-black py-4 rounded-2xl transition-all shadow-lg active:scale-95 flex items-center justify-center gap-2">
                  <span>DOWNLOAD GAME (10.9 GB)</span>
                </button>
              </a>
            </div>
          </motion.div>
          ...
          >
            <div>
              <div className="flex items-center gap-3 mb-4">
                <span className="bg-orange-500/10 text-orange-500 text-[10px] font-black uppercase tracking-widest px-3 py-1 rounded-full border border-orange-500/20">Survival Horror Online</span>
                <span className="bg-white/5 text-slate-400 text-[10px] font-black uppercase tracking-widest px-3 py-1 rounded-full border border-white/5">Version v1.0 Full Release</span>
              </div>
              <h1 className="text-8xl font-black italic uppercase tracking-tighter text-white leading-none">
                Sons Of The <span className="text-orange-600">Forest</span>
              </h1>
            </div>
            ...
            <div className="bg-slate-900/30 border border-white/5 rounded-3xl p-8 space-y-6">
               <h3 className="text-lg font-black uppercase italic tracking-tighter text-orange-500">Survival is Everything</h3>
               <p className="text-slate-400">
                Experience complete freedom to tackle the world how you want. You decide what you do, where to go and how best to survive. There are no NPC’s snapping orders at you or giving you missions you don’t want to do. You give the orders.
               </p>
            </div>

            {/* Tags */}
            <div className="flex flex-wrap gap-2">
               {["Survival", "Open World", "Horror", "Crafting", "Co-op"].map(tag => (
        ...
        <section className="mb-20">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {[ 
              "https://ankergames.net/uploads/screenshots/02-2025/Sons%20Of%20The%20Forest%20Steam%20GAME_1740052138.webp",
              "https://ankergames.net/uploads/screenshots/02-2025/Sons%20Of%20The%20Forest%20Reviews_1740052138.webp",
              "https://ankergames.net/uploads/screenshots/02-2025/Sons%20Of%20The%20Forest%20Online_1740052138.webp",
              "https://ankergames.net/uploads/screenshots/02-2025/Sons%20Of%20The%20Forest%20AnkerGames_1740052138.webp" 
            ].map((src, i) => (
              <motion.div 
                key={i}
                whileHover={{ scale: 1.05, zIndex: 10 }}
                className="rounded-xl overflow-hidden border border-white/10 cursor-zoom-in bg-slate-900 shadow-xl"
              >
                <img src={src} alt={`SOTF Screenshot ${i}`} className="w-full h-full object-cover aspect-video" />
              </motion.div>
            ))}
          </div>
        </section>
          ...
          <div className="bg-slate-900/40 border border-white/5 rounded-[2rem] overflow-hidden">
            ...
            <div className="p-8 space-y-6">
              ...
              <div className="flex gap-4 items-start">
                ...
                <p className="text-sm text-slate-300">Just **extract the rar / zip file** using WinRAR or 7-Zip.</p>
              </div>
              <div className="flex gap-4 items-start">
                <span className="text-orange-500 font-black text-lg">3</span>
                <p className="text-sm text-slate-300">Simply **launch the game from sonsoftheforest.exe** inside the game folder.</p>
              </div>
            ...
            <div className="p-8">
              ...
              <div className="space-y-1">
                {[
                  ...
                  { label: "Processor", value: "Intel Core i7-8700K / AMD Ryzen 5 3600X" },
                  { label: "Memory", value: "16 GB RAM" },
                  { label: "Graphics", value: "NVIDIA GeForce 1080Ti / AMD Radeon RX 5700 XT" },
                  { label: "DirectX", value: "Version 11" },
                  { label: "Network", value: "Broadband Internet connection" },
                  { label: "Storage", value: "20 GB available space" },
                  { label: "Sound Card", value: "DirectX Compatible Sound Card" },
                ].map((req, i) => (
